...
from database import get_student, get_transactions, get_student_homeworks, register_student
...
def verify_telegram_data(init_data: str) -> dict | None:
    """
    Verifies that the data actually came from Telegram.
    Returns user data if valid, None if fake.
    """
    try:
